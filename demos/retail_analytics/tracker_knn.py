...
from demos.retail_analytics.knn_detector import KnnDetector, DistanceMetric
from demos.retail_analytics.trail import Trail
...
class KNNTracker(object):
    ...
    @staticmethod
    def associate_detections_to_trackers(f_vecs, trackers, bboxes, distance_threshold=.375):
        """
