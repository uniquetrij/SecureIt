...
from obj_detect.tf_api.object_detection.metrics import oid_vrd_challenge_evaluation_utils as utils
from obj_detect.tf_api.object_detection.protos import string_int_label_map_pb2
from obj_detect.tf_api.object_detection.utils import vrd_evaluation
